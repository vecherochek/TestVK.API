    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a4408f31-cf9b-49d8-b19c-56387a58cdb1"), "Admin", "Admin" },
                    { new Guid("f5b2ebd4-6446-4c45-9b91-cfacd5957818"), "User", "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("14058055-cb2f-449d-afb1-2f0525eaeaa4"), "Blocked", "User does not exist" },
                    { new Guid("8347b2dc-8656-4380-80d6-9bf38c0644ae"), "Active", "User exists" }
                });
